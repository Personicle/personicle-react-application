...
const ProfileScreen = ({ navigation }) => {
  ...
  const VisibleItem = (props) => {
    ...
    return (
      <Animated.View style={[styles.rowFront]}>
        ...
        >
          <View>
            <Text style={styles.phyTitle}>{data.item.name}</Text>
  ...
  return (
    <>
      ...
      {userData["data"] === undefined && userData.isRefetching && (
            ...
            <View style={styles.userInfoSection}>
              <View style={styles.row}>
                ...
                <Text style={{ color: "#777777", marginLeft: 20 }}>
                  {userData["data"]["data"]["info"]["city"]},{" "}
                  {userData["data"]["data"]["info"]["country"]}
                </Text>
              </View>
              {/* <View style={styles.row}>
              ...
              <View style={styles.row}>
                <TouchableOpacity
                  style={styles.row}
                  onPress={() =>
                    navigate("AddPhysician", { testImage: profileImage })
                  }
                >
